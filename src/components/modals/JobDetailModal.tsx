...
import { Clock, MapPin, DollarSign, Briefcase, TrendingUp, CheckCircle, Building2 } from 'lucide-react';
        ...
        >
          <div className="space-y-6">
            ...
            <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getSportTagColor(job.sportType)}`}>
              ...
              <span className="bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-sm font-medium">
              REMOTE
            </span>
            </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    {job.company.toLowerCase().replace(/\s+/g, '').replace(/[^a-z0-9]/g, '') + '.com'}
                  </p>
                </div>
              </div>
